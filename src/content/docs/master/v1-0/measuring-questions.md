...
Measuring questions follow the format, "compared to me, are you closer to or further from _____?" Valid answers are **closer** and **further**. Hiders have five minutes to answer. These questions are also universally useful, and good for slicing the map in unique and clever ways. **It is important to note that if locations are not within a map's boundaries, players must operate as if they do not exist**. For example, if seekers asked if they were closer to or further from an international border than the hider, but there were no international borders in the map's boundaries, it would return a null answer (null answers count as answered questions, and hiders get to draw cards.)
...
![Compared to me, are you closer or further from a coastline](https://gist.github.com/user-attachments/assets/aaff2181-ef8c-4866-8a4d-235f0b64f587)![Compared to me, are you closer or further from an airport](https://gist.github.com/user-attachments/assets/625c6862-f127-4f97-ad23-574a53865f01)
...
Different countries sometimes have different definitions of high speed rail, so it is worth using whatever definition is locally applicable. Otherwise, we recommend following the EU definition. Minimum speed of 250 km/h (155mph) on lines specially built for high speed and of about 200km/h (124mph) on existing lines which have been specially upgraded.
### Rail Station
...
For our purposes, a coastline is defined as any place where land meets either the ocean, a great lake, or a body of water that flows directly into the ocean or great lake via a waterway that is never less than 1 mile (1.61km) across.

You can see this illustrated below:
![Coastline illustration](https://gist.github.com/user-attachments/assets/2ddc55cd-047f-4dc2-a86e-7b5ed9caed55)
